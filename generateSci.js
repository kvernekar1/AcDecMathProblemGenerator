...
const science = await new PDFLoader('Science-Resource-Guide.pdf').load();
...
for (const chunk of science) {
  ...
  try {
    ...
    for (const item of data) {
      ...
      rows.push([q, a, b, c, d, e, ans, expl, 'Science', section]);
    }
