...
- Since this is for the Art subject, focus on topics such as art history, techniques, movements, influential artists, and significant artworks.
...
const model = await ai.batches.create({
    ...
    src: requests,
    config: {
        displayName: 'Art Test Generation Batch',
        temperature: 0.3
    }
});
