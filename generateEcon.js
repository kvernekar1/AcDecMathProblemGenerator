...
- Since this is economics, focus on economic principles and its applications, as well as historical and contemporary economic events.
...
for (const chunk of economics) {
  ...
  try {
    ...
    for (const item of data) {
      ...
      rows.push([q, a, b, c, d, e, ans, expl, 'Economics', section]);
    }
